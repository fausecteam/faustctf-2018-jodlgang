"""
Django settings for jodlgang project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'jodlplatform.context_processors.show_ambassador'
            ],
        },
    },
]

WSGI_APPLICATION = 'jodlgang.wsgi.application'
